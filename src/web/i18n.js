const translations = {
  en: {
    ...
    "btn-create-api-key": "Create API Key",
    "btn-create-memory-bank": "Create Memory Bank",
    ...
    "profile-no-profiles":
      "No user profiles available yet. Profiles are created as you interact with the memory system.",
    ...
    "modal-confirm-cleanup-desc":
      "This will remove all memories that are no longer relevant. Continue?",
  ...
  zh: {
    ...
    "section-api-keys": "用户 API 密钥",
    "section-memory-banks": "记忆库",
    "placeholder-api-key-name": "API 密钥名称",
    "placeholder-api-key-description": "API 密钥描述",
    "placeholder-memory-bank-name": "记忆库名称",
    "placeholder-memory-bank-description": "记忆库描述",
    "btn-create-api-key": "创建 API 密钥",
    "btn-create-memory-bank": "创建记忆库",
    "modal-generated-key-title": "生成的用户 API 密钥",
    "modal-generated-key-desc": "请立即复制此密钥。它不会再次显示。",
    "toast-api-keys-failed": "加载 API 密钥失败",
    "toast-api-key-create-failed": "创建 API 密钥失败",
    "toast-memory-banks-failed": "加载记忆库失败",
    "toast-memory-bank-create-failed": "创建记忆库失败",
    "toast-select-api-key": "请先选择 API 密钥",
    "toast-no-active-memory-bank": "没有活动的记忆库",
